...
@Component({
  selector: 'app-collect-all',
  templateUrl: './collect-all.page.html',
  styleUrls: ['./collect-all.page.scss'],
})
export class CollectAllPage implements OnInit, OnDestroy {
  private lastPageReachedSub: Subscription;
  private allCollectionsLoaded = false;
  private newCollectionSubscription: Subscription;
  newCollections: CollectionData[];
  ...
  ngOnDestroy() {
    ...
    this.newCollectionSubscription.unsubscribe();
  }
